...
console.log(sum);
console.log(sum(3421341234123,13412341234));
...
const greet3 =()=>{console.log("안녕하세요 :) 화살표함수입니다."}
greet3();
...
//? 인자값 (아규먼트, argument) 
// 실제 계산을 위해서 (함수 사용을 위해) 파라미터로 전달되는 값 
// 파라미터가 변수의 선언
// 인자값 변수의 할당
