...
// 내부의 데이터가 서버에 전송되고 페이지가 리로드 된다.
// >> 이러한 기본 행동을 방지 메서드 : preventDefault();
...
childButton.addEventListener("click", function(e) {
  ...
  e.stopPropagation(); // 자식 요소에서 지정한다.
})