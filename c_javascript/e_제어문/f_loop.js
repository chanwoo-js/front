...
// - 기본으로 부여되는 순서 index ( 인덱스, 시작이 0부터 증가하는 수)
// - 배열 내부의 데이터를 요소라고 부름
...
let js = ["자바스크립트", 123, true, null, undefined, [1,2,3,4]];
...
for (초기화식; 종료조건; 증감식) {
  ...
  >> true 면 중괄호 코드 실행, false명 반복문 종료
...
// for (let i = 5; i > 0; i--) {
//   let stars = "";
//   // 별의 개수에 대한 반복 5~1까지 실행
//   for (let j = 0; j<i; j++ ){
//     // 첫번째 행 (i가 5) >> 0,1,2,3,4
//     stars += "*";
//   }
//   console.log(stars)
// }
